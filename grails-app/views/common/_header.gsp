<%@ page import=" bv.UserService; bv.UserLog; auth.User;org.springframework.security.core.context.SecurityContextHolder;org.springframework.security.core.Authentication;org.springframework.security.core.context.SecurityContext" %>
<style type="text/css">
...
<div id="header">
    <div id="header-in">
        <%
            ...
            //get username
            String username = auth.principal.username
...
//            }
            ...
            if(username != "__grails.anonymous.user__"){
                ...
                def saveUserLog = new UserService().saveUserLog(authIpAddress,authLogStr,now,authUserId)
